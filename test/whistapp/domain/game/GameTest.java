...
class GameTest {
    ...
    void initializeHumanPlayers() {
        Game gameEmpty = new ScoreGame(players);
    ...
    void getScoresPerPlayer_start() {
        ...
        assertEquals(0, scores.get(player1));
        assertEquals(0, scores.get(player2));
        assertEquals(0, scores.get(player3));
        assertEquals(0, scores.get(player4));
    }
    ...
    void setAllScores() {
        ...
        assertEquals(10, scores.get(player2));
        assertEquals(10, scores.get(player3));
        assertEquals(10, scores.get(player4));
    }
}
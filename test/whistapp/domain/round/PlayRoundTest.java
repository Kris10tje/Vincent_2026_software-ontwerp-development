...
class PlayRoundTest {
    ...
    void setUp() {
        ...
        player3 = new Player("Jacky");
        player4 = new HighBot("Alice");
    ...
    void testConstructor() {
        ...
        assertEquals(13, round.getPlayers().get(0).getHandCards().length);
        assertEquals(13, round.getPlayers().get(1).getHandCards().length);
        assertEquals(13, round.getPlayers().get(2).getHandCards().length);
        assertEquals(13, round.getPlayers().get(3).getHandCards().length);
    ...
    void submitBid2() {
        ...
        assertEquals(BidType.ABONDANCE_9, round.getHighestBid());
        assertEquals(Player.getNextPlayer(players, Player.getNextPlayer(players, round.getDealer())), round.getCurrentBiddingPlayer());
    }
    ...
    void evaluateAndAdvanceTrick() {
        ...
        round.startPlayingRound();
        round.processCardPlay(round.getCurrentPlayingPlayer().getHandCards()[0]);
        round.processCardPlay(round.getCurrentPlayingPlayer().getHandCards()[0]);
        round.processCardPlay(round.getCurrentPlayingPlayer().getHandCards()[0]);
        round.processCardPlay(round.getCurrentPlayingPlayer().getHandCards()[0]);
    ...
    void getTrumpSuit2() {
        ...
        assertNotNull(round.getOriginalTrumpSuitName());
    }
    ...
    void getCardsFromPreviousTrick() {
        ...
        round.evaluateRoundBids();
        round.startPlayingRound();
        String c1 = round.getCurrentPlayingPlayer().getHandCards()[0];
        round.processCardPlay(c1);
        String c2 = round.getCurrentPlayingPlayer().getHandCards()[0];
        round.processCardPlay(c2);
        String c3 = round.getCurrentPlayingPlayer().getHandCards()[0];
        round.processCardPlay(c3);
        String c4 = round.getCurrentPlayingPlayer().getHandCards()[0];
        round.processCardPlay(c4);
